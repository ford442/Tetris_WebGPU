// Binding-free PBR helpers. Shared verbatim with the Emscripten C++ renderer
// (embedded by scripts/generate-cpp-shaders.mjs), so nothing here may reference a
// @binding: every input is a parameter. Binding-dependent helpers (IBL sampling,
// backdrop refraction) live in pbrFunctions.wgsl, which concatenates this file.
