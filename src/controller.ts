...
export default class Controller {
  ...
  readonly MOVE_BUFFER_WINDOW: number = 40; // ms - Tighter, snappier movement
  readonly JUMP_BUFFER_WINDOW: number = 40; // ms - Strict buffer for jump-like actions to prevent double-rotation
